...
// Handwritten display font for doodle-style headlines & accents.
const caveat = Caveat({
...
export const metadata: Metadata = {
  ...
  description:
    "Lost your job to AI? You're not alone. Discover which careers match your skills and experience, and find your next opportunity.",
};
